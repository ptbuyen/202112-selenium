...
//    private static final By figureSel = By.cssSelector(".figure"); // use "." to declare class by cssSelector
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Find a list of figure on the page
            ...
            if (figureElems.isEmpty())
                throw new RuntimeException("There is no user figure on the page");
            else {
